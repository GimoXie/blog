package com.gimo.blog.web.lucene;
...
import com.gimo.blog.web.util.DateUtil;
...
public class BlogIndex {
	...
	private IndexWriter getWriter()throws Exception{
		...
		if(os.toLowerCase().startsWith("win")){  
			path = PropertiesUtils.getProperties("lucene.path.win");
		}else{
			path = PropertiesUtils.getProperties("lucene.path.linux");
		}
