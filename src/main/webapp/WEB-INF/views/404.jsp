...
<link href="static/assets/css/pages/error.css" rel="stylesheet" type="text/css" />
    ...
    <div class="row">
        <div class="col-md-12 page-404">
            ...
            <div class="details">
                ...
                <form action="${pageContext.request.contextPath}/articles/search.html" onsubmit="return checkData()">
                    <div class="input-group input-medium">
                        <input type="text" id="404q" name="q" value="${q}" class="form-control" placeholder="keyword..."> <span class="input-group-btn">
